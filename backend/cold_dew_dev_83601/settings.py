"""
Django settings for cold_dew_dev_83601 project.
...
ROOT_URLCONF = 'cold_dew_dev_83601.urls'
...
WSGI_APPLICATION = 'cold_dew_dev_83601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_dew_dev_83601 API",
    "DESCRIPTION": "API documentation for cold_dew_dev_83601 App",
    "VERSION": "v1",
}
